...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        String resultStr=new String(num1 + " " + oper + " " + num2 + " = " + result);
        Thread t=new sendMessage(resultStr);
        t.start();
    ...
    class sendMessage extends Thread{
      ...
      public sendMessage(String resultStr)
      {
          this.strToSend=new String(resultStr);
      }
        public void run(){
            try{
                int serverPort = 2000;
